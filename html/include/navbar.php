<?php
/**
 * Legacy navbar include — use elements/navbar.php for new installs.
 * Kept in sync so older templates still get the full language list.
 */
...
<nav class="main-header navbar navbar-expand-lg navbar-light navbar-dark text-sm">
    <div class="container text-nowrap">
        <a href="./index.php" class="navbar-brand">
            <img src="img/systemx-nav.png" alt="System X" class="brand-image img-circle elevation-3"
                style="opacity: .8">
            <!-- <span class="brand-text font-weight-light">System X</span> -->
        </a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-hover">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                        ...
                        <li>
                            <a href="https://freestar.network/systemx-dmr" class="dropdown-item" id="nav_freestar"></a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="https://twitter.com/freestarnetwork/" role="button">
                    <i class="fab fa-telegram-plane"></i>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://www.facebook.com/groups/5075067229200822/" role="button">
